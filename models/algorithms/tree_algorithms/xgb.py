...
from models.algorithms.tree_algorithms.helper import forecast_pod_with_tree, train_xgb
from models.algorithms.unbundled import run_unbundled
from models.base import ForecastModel
from validation.series import consumption_columns


def forecast_xgb_unbundled(model: ForecastModel, spark) -> ForecastResults:
